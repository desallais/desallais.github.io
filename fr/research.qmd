...
## Coexistence, faisabilité et stabilité structurelle {#coexistence}

![Figure provisoire pour cet axe de recherche.](../assets/img/coexistence.svg){fig-alt="Figure provisoire"}
...
Équation provisoire, conservée ici pour garder le rendu mathématique visible
tant que le texte ne l'est pas : une communauté de $S$ espèces d'abondances
$N_i$ suit
...
de sorte que la faisabilité impose $N^\star = A^{-1} r > 0$.
...
## Biodiversité et fonctionnement des écosystèmes {#bef}

![Figure provisoire pour cet axe de recherche.](../assets/img/bef.svg){fig-alt="Figure provisoire"}
...
## Structure et dynamique des réseaux trophiques {#food-webs}

![Figure provisoire pour cet axe de recherche.](../assets/img/food-webs.svg){fig-alt="Figure provisoire"}
